  ...
  <div class="container">
    ...
    <aside class="sidebar">
      <ul>
        ...
        <li><a href="inventory/suppliers.php"><i class="fas fa-truck"></i> Suppliers</a></li>
        <li><a href="inventory/budget.php"><i class="fas fa-money-bill"></i> Budget</a></li>
        <li><a href="inventory/income-costs.php"><i class="fas fa-file-invoice-dollar"></i> Income & Costs</a></li>
      <li><a href="inventory/sales.php"><i class="fas fa-chart-line"></i> Sales</a></li>
        <li><a href="inventory/orders.php" id="ordersMenuItem"><i class="fas fa-shopping-cart"></i> Orders</a></li>
        <li><a href="inventory/customers.php"><i class="fas fa-users"></i> Customer Management</a></li>
        <li><a href="inventory/shipment.php"><i class="fas fa-shipping-fast"></i> Shipment & Purchase</a></li>
        <li><a href="inventory/roles.php" id="rolesMenuItem"><i class="fas fa-user-cog"></i> Role Management</a></li>
      </ul>
