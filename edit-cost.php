...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $pdo->prepare("UPDATE costs SET cost_category = :cost_category, cost_description = :cost_description, 
                           cost_amount = :cost_amount, cost_date = :cost_date WHERE id = :id");
    $stmt->bindParam(':cost_category', $costCategory);
    $stmt->bindParam(':cost_description', $costDescription);
    $stmt->bindParam(':cost_amount', $costAmount);
    $stmt->bindParam(':cost_date', $costDate);
    $stmt->bindParam(':id', $costId, PDO::PARAM_INT);
...
<head>
  ...
  <link rel="stylesheet" href="styles/cost-form.css">
    ...
    <main class="main-content">
      ...
      <form class="cost-form" method="POST" action="edit-cost.php?id=<?php echo $cost['id']; ?>">
        <div class="form-group">
          ...
          <input type="text" id="costCategory" name="costCategory" value="<?php echo htmlspecialchars($cost['cost_category']); ?>" required>
        </div>

        <div class="form-group">
          <label for="costDescription">Cost Description</label>
          <textarea id="costDescription" name="costDescription" required><?php echo htmlspecialchars($cost['cost_description']); ?></textarea>
        </div>

        <div class="form-group">
          <label for="costAmount">Cost Amount</label>
          <input type="number" id="costAmount" name="costAmount" value="<?php echo htmlspecialchars($cost['cost_amount']); ?>" required>
        </div>

        <div class="form-group">
          <label for="costDate">Cost Date</label>
          <input type="date" id="costDate" name="costDate" value="<?php echo htmlspecialchars($cost['cost_date']); ?>" required>
        </div>
